...
<h5>- If you have problem when booting to macOS (OS X) by OpenCore, you can use this <a href="https://github.com/qilskcter/Dell-Vostro-3460-Hackintosh/blob/main/OpenCore/EFI.zip">EFI</a>.</h5>
